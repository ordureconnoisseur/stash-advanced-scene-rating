    ...
    async function openModal(sceneId) {
        ...
        function render() {
            ...
            const categoryDescriptions = {
                "Production Quality": "This evaluates the technical craft behind the scene: video resolution and sharpness, lighting quality and how well it illuminates bodies and key details, camera angles and movement during penetration, oral, and close-ups, audio clarity of moans, breathing, and dialogue, and overall editing smoothness and polish. It also considers consistency — whether the technical quality holds up throughout the scene rather than only in its highlight moments.",
                "Chemistry": "This measures the visible attraction and connection between performers: eye contact during sex, authenticity and passion of kissing, responsiveness to each other’s touch, and the sense that performers are genuinely enjoying each other rather than performing mechanically. It also captures natural spontaneity and improvisation during oral, penetration, and foreplay, and the overall dynamic — whether the performers feel like they actually want each other.",
                "Performance": "This assesses each performer’s individual energy and commitment: the intensity and realism of moans and facial expressions, stamina and endurance during extended or demanding scenes, visible physical arousal such as muscle contractions, natural wetness, and erection quality, commitment to difficult or extreme acts, quality of dirty talk and verbal engagement, and the degree to which each performer elevates the scene through their presence and enthusiasm.",
                "Aesthetics": "This covers the visual appeal of the performers and how they are presented on screen: body shape and proportions, grooming and presentation of genitals and pubic areas, visual quality of breasts, buttocks, penises, and vulvas when aroused, variety and attractiveness of positions, how well the framing highlights bodies and penetration, and the visual appeal of bodily fluids, cum shots, or other physical payoffs.",
